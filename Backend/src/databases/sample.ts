...
export const INIT_PERMISSIONS = [
  ...
  {
    _id: '6698b48a86d0d641c2df2f30',
    name: 'Lấy danh sách phiếu thu theo tháng và năm',
    apiPath: '/api/v1/receipts/by-month-year',
    method: 'GET',
    module: 'RECEIPTS',
    createdBy: {
      _id: '647b5108a8a243e8191855b5',
  ...
  {
    _id: '6698b4ad86d0d641c2df2f39',
    name: 'Lấy danh sách phiếu chi theo tháng và năm',
    apiPath: '/api/v1/expenses/by-month-year',
    method: 'GET',
    module: 'EXPENSES',
    createdBy: {
      _id: '647b5108a8a243e8191855b5',
