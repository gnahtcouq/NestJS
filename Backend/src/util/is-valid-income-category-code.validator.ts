...
export function IsValidIncomeCategoryCode(
  validationOptions?: ValidationOptions,
) {
  return function (object: Object, propertyName: string) {
    registerDecorator({
      name: 'isValidIncomeCategoryCode',
      ...
      validator: {
        ...
        defaultMessage(args: ValidationArguments) {
          return 'Mã danh mục thu phải có định dạng DMTYYYYMMDD với YYYYMMDD là một ngày hợp lệ, không vượt quá ngày hiện tại, và phải lớn hơn hoặc bằng ngày 01/01/1970';
        },
      },
    });
  };
