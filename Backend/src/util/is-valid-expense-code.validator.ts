...
export function IsValidExpenseCode(validationOptions?: ValidationOptions) {
  return function (object: Object, propertyName: string) {
    registerDecorator({
      name: 'isValidExpenseCode',
      ...
      validator: {
        ...
        defaultMessage(args: ValidationArguments) {
          return 'Mã phiếu chi phải có định dạng PCYYYYMMDD với YYYYMMDD là một ngày hợp lệ, không vượt quá ngày hiện tại, và phải lớn hơn hoặc bằng ngày 01/01/1970';
        },
      },
    });
  };
